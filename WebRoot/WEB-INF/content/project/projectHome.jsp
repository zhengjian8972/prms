...
<body class="t1">
	...
	<div id="mt" class="gtb">
		<a href="../project/home" class="tab active">Projects</a> <a
			href="../member/home" class="tab ">Members</a> <a
			href="../report/home" class="tab ">Reports</a> <a href="#"
			class="tab ">Wiki</a>
		<div class="gtbc"></div>
	</div>

	<div id="wrap">
		<div id="home"><jsp:include page="home.jsp"></jsp:include></div>
		<div id="project" style="display:none;"><jsp:include
				page="projectManage.jsp"></jsp:include></div>
	</div>

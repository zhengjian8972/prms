				...
				<div class="st1">
					<div class="isf">
						...
						<s:iterator value="#session.allProjectMap">
							<span class="inst3" id="<s:property value="key"/>"> <a><s:property
										value="value" /> </a> </span>&nbsp;
								</s:iterator>
			...
			<tr class="pscontent">
				<td class="pscolumnl" style="width: 25%;">
					...
					<div class="psicon">
						<span class="SPRITE_star_off goog-inline-block vt"
							...
							style="cursor: pointer line-height : 15px;"> </span> 项目中有 <span
							id="group_count">2</span>&nbsp;个组。

						<ul class="pslist" id ="group_list">
							<li class="psmeta"><a href="#">管理组</a>
							</li>
							<li class="psmeta"><a href="#">后台编程组</a>
							</li>
							<li class="psmeta"><a href="#">前台编程组</a>
							</li>
						</ul>
					</div>
					<div class="psicon" >
						<span class="psicon-container goog-inline-block"> <span
							style="float:right"
							class="SPRITE_people-y16 goog-inline-block vt"></span> </span> 项目中有 <span
							id="member_count">5</span>&nbsp;名成员。
						<ul class="pslist" id = "member_list">
							<li class="psmeta"><a href="#">阿信</a>
							</li>
							<li class="psmeta"><a href="#">玛莎</a>
							</li>
							<li class="psmeta"><a href="#">怪兽</a>
							</li>
							<li class="psmeta"><a href="#">石头</a>
							</li>
							<li class="psmeta"><a href="#">冠佑</a>
							</li>
							<li class="psmeta"><a href="#">脑残粉</a>
							</li>
						</ul>
					</div>
				...
				<td id="project-list" style="width: 75%;">
					<div id="colcontrol">
						...
						<!-- 成列组名单 -->
						<span class="group_title">管理组 </span> <span class="group_op">
							<span class="SPRITE_new-23 goog-inline-block vt"></span> <a
							class="func_link_word" id="delete_group">删除该组 </a> <span
							class="SPRITE_people-y16 goog-inline-block vt"></span><a
							class="func_link_word" id="add_member">添加成员 </a> </span>
						...
						<table cellspacing="0" cellpadding="2" border="0" class="results"
							...
							<thead>
								...
								<tr id="headingrow">
									...
									<th class="col_0" nowrap="nowrap"><a href="#"
										style="text-decoration: none">学号 </a>
									</th>
									...
									<th class="col_2" nowrap="nowrap"><a href="#"
										style="text-decoration: none">组内权限 </a>
									</th>
							...
							<tbody id="memberTable">
								...
								<tr class="ifOpened">
									...
									<td class="vt id col_0"><a href="#"> 2011110776 </a>
									</td>
									<td class="vt col_1" width="100%"><a
										onclick="cancelBubble=false" href="#">Agüero </a>
									</td>
									<td class="vt col_2"><a onclick="cancelBubble=false"
										href="#" style="white-space: nowrap">组长</a>
									</td>
									<td class="vt col_3"><a
						...
						&nbsp;&nbsp;
						<!-- 成列组名单 -->
						<span class="group_title">前台编码组 </span> <span class="group_op">
							<span class="SPRITE_new-23 goog-inline-block vt"></span> <a
							class="func_link_word" id="delete_group">删除该组 </a> <span
							class="SPRITE_people-y16 goog-inline-block vt"></span><a
							class="func_link_word" id="add_member">添加成员 </a> </span>

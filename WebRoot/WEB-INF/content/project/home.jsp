				...
				<td class="pscolumnl" style="width: 25%;">
					...
					<div class="psicon">
						<span class="SPRITE_star_off goog-inline-block vt"
							...
							style="cursor: pointer line-height : 15px;"> </span> 实验室中共有 <span
							id="project_count"><s:property value="projectNum" />
						</span>&nbsp;个项目。
							...
							<thead>
								<tr id="headingrow">
									...
									<th class="col_0" nowrap="nowrap"><a href="#"
										style="text-decoration: none">项目名 </a></th>

									<th class="col_1_p" nowrap="nowrap" id="description"
										width="100%"><a href="#" style="text-decoration: none">项目描述</a>
									</th>

									<th class="col_2_p" nowrap="nowrap"><a href="#"
										style="text-decoration: none"> 项目成员数 </a></th>

									<th class="col_3" nowrap="nowrap"><a href="#"
										style="text-decoration: none">项目管理员 </a></th>
								</tr>
							</thead>

			...
			<tr class="pscontent">
				<td class="pscolumnl" style="width: 25%;">
					...
					<div class="psicon" style="margin-top: 20px; line-height: 15px;">
						<span class="SPRITE_people-y16 goog-inline-block vt"></span>
						<span> 实验室共有成员 <span id="member-count"><s:property value="memberNum"/>&nbsp;</span>名。 </span>
					</div>
					...
					<div id="colcontrol">
						<div class="list">
							<div class="pagination">
								1 - <s:property value="memberNum"/> of <s:property value="memberNum"/>
							</div>
							&nbsp;&nbsp;
						</div>
							...
							<thead>
								<tr id="headingrow">
									...
									<th class="col_2" nowrap="nowrap">
										<a href="#" style="text-decoration: none">所属项目 </a>
									</th>
								...
								<tr class="ifOpened" >
									...
									<td class="vt col_2">
										<a onclick="cancelBubble=false" href="#"
											style="white-space: nowrap">PDM;PETL;打败曼联</a>
									</td>
